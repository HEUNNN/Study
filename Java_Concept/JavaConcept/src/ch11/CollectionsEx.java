...
public class CollectionsEx {
    public static void main(String[] args) {
        ...
        System.out.println("max = " + max(list)); // Collections.max(list) , import해주어서 Collections 생략 가능
        ...
        replaceAll(list, 2, 1); // oldValue -> newValue로 대체
        System.out.println("list = " + list);

        Enumeration e = enumeration(list); // Iterator의 구버전
