...
//    @GetMapping(value = "/users/{id}", headers = "X-API-VERSION=1") // headers를 이용한 API version 관리
    @GetMapping(value = "/v1/users/{id}", produces = "application/vnd.company.appv1+json") // Accept 헤더를 사용한 API version 관리
...
//    @GetMapping(value = "/users/{id}", headers = "X-API-VERSION=2") // headers를 이용한 API version 관리
    @GetMapping(value = "/v2/users/{id}", produces = "application/vnd.company.appv2+json") // Accept 헤더를 사용한 API version 관리
